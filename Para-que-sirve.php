                    ...
                    <div class="u-layout-row">
                        ...
                        <div
                            ...
                            <div class="u-container-layout u-container-layout-2">
                                ...
                                <p class="u-text u-text-palette-1-base u-text-2">Ofrecer una solución integral y
                                    personalizada para el bienestar y la salud de las personas, a través de una
                                    aplicación móvil innovadora y fácil de usar.&nbsp;&nbsp;<br>
                                </p>
                                <h2 class="u-text u-text-palette-1-base u-text-1">MISIÓN</h2>
                                <p class="u-text u-text-palette-1-base u-text-2">Ser la aplicación líder en el mercado
                                    de la salud digital, empoderando a las personas para que tomen control de su salud y
                                    alcancen sus objetivos de bienestar de forma sostenible.&nbsp;&nbsp;<br>
                                </p>
